...
def lesson1():
    ...
    print("Compiled stuff")
    print(jax.xla_computation(f1_jit)(jnp.arange(8), jnp.ones(8, dtype=int)).as_hlo_text())
    print(f1_jit.lower(jnp.arange(8), jnp.ones(8, dtype=int)).compiler_ir('stablehlo'))
...
def lesson5():
    ...
    c = jax.xla_computation(f5)(jnp.array([1,2,3,4,5]))
    print(c.as_hlo_text())
    # print(f5.lower(jnp.array([1,2,3,4])).compiler_ir("stablehlo"))
